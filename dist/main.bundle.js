...
var AppComponent = (function () {
    ...
    AppComponent.prototype.onClickHistory = function (event, i) {
        var videoID = this.historyVideos[i].id;
        var videoName = this.historyVideos[i].snippet.title;
        this.getVideo(videoID, videoName);
    };
