...
var AppComponent = (function () {
    ...
    AppComponent.prototype.addPlaylistItem = function (list, i) {
        var _this = this;
        // Relative vidoes
        var playlistItem = this.playlistVideos.find(function (item) { return item.id.videoId === _this.relatedVideos[i].id.videoId; });
